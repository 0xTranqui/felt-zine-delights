...
export interface ERC721DropProxyInterface extends utils.Interface {
    functions: {};
    events: {
...
export interface ERC721DropProxy extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ERC721DropProxyInterface;
