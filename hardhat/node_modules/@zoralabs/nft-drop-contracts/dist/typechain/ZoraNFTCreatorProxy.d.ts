...
export interface ZoraNFTCreatorProxyInterface extends utils.Interface {
    functions: {};
    events: {
...
export interface ZoraNFTCreatorProxy extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ZoraNFTCreatorProxyInterface;
