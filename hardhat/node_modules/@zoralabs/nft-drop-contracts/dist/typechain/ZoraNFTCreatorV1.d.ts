...
export interface ZoraNFTCreatorV1Interface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "contractVersion" | "createDrop" | "createEdition" | "dropMetadataRenderer" | "editionMetadataRenderer" | "implementation" | "initialize" | "owner" | "proxiableUUID" | "renounceOwnership" | "transferOwnership" | "upgradeTo" | "upgradeToAndCall"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "editionMetadataRenderer", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "editionMetadataRenderer", data: BytesLike): Result;
...
export declare type CreatedDropEvent = TypedEvent<[
    string,
    string,
    BigNumber
], CreatedDropEventObject>;
export declare type CreatedDropEventFilter = TypedEventFilter<CreatedDropEvent>;
...
export interface ZoraNFTCreatorV1 extends BaseContract {
    ...
    functions: {
        ...
        createDrop(name: string, symbol: string, defaultAdmin: string, editionSize: BigNumberish, royaltyBPS: BigNumberish, fundsRecipient: string, saleConfig: IERC721Drop.SalesConfigurationStruct, metadataURIBase: string, metadataContractURI: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        createEdition(name: string, symbol: string, editionSize: BigNumberish, royaltyBPS: BigNumberish, fundsRecipient: string, defaultAdmin: string, saleConfig: IERC721Drop.SalesConfigurationStruct, description: string, animationURI: string, imageURI: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        contractVersion(overrides?: CallOverrides): Promise<number>;
        createDrop(name: string, symbol: string, defaultAdmin: string, editionSize: BigNumberish, royaltyBPS: BigNumberish, fundsRecipient: string, saleConfig: IERC721Drop.SalesConfigurationStruct, metadataURIBase: string, metadataContractURI: string, overrides?: CallOverrides): Promise<string>;
        createEdition(name: string, symbol: string, editionSize: BigNumberish, royaltyBPS: BigNumberish, fundsRecipient: string, defaultAdmin: string, saleConfig: IERC721Drop.SalesConfigurationStruct, description: string, animationURI: string, imageURI: string, overrides?: CallOverrides): Promise<string>;
        dropMetadataRenderer(overrides?: CallOverrides): Promise<string>;
        editionMetadataRenderer(overrides?: CallOverrides): Promise<string>;
        implementation(overrides?: CallOverrides): Promise<string>;
    ...
    filters: {
        ...
        "CreatedDrop(address,address,uint256)"(creator?: string | null, editionContractAddress?: string | null, editionSize?: null): CreatedDropEventFilter;
        CreatedDrop(creator?: string | null, editionContractAddress?: string | null, editionSize?: null): CreatedDropEventFilter;
