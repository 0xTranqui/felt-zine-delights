...
export declare namespace IERC721Drop {
    ...
    type SalesConfigurationStructOutput = [
        BigNumber,
        number,
        BigNumber,
        BigNumber,
...
export interface ERC721DropInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "DEFAULT_ADMIN_ROLE" | "MINTER_ROLE" | "SALES_MANAGER_ROLE" | "adminMint" | "adminMintAirdrop" | "approve" | "balanceOf" | "burn" | "config" | "contractURI" | "contractVersion" | "finalizeOpenEdition" | "getApproved" | "getRoleAdmin" | "grantRole" | "hasRole" | "initialize" | "isAdmin" | "isApprovedForAll" | "metadataRenderer" | "mintedPerAddress" | "name" | "owner" | "ownerOf" | "presaleMintsByAddress" | "proxiableUUID" | "purchase" | "purchasePresale" | "renounceRole" | "revokeRole" | "royaltyInfo" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "saleDetails" | "salesConfig" | "setApprovalForAll" | "setFundsRecipient" | "setOwner" | "setSaleConfiguration" | "supportsInterface" | "symbol" | "tokenURI" | "totalSupply" | "transferFrom" | "upgradeTo" | "upgradeToAndCall" | "withdraw" | "zoraFeeForAmount" | "zoraFeeManager"): FunctionFragment;
...
export declare type FundsReceivedEvent = TypedEvent<[
    string,
    BigNumber
], FundsReceivedEventObject>;
export declare type FundsReceivedEventFilter = TypedEventFilter<FundsReceivedEvent>;
export interface FundsRecipientChangedEventObject {
    newAddress: string;
    changedBy: string;
}
export declare type FundsRecipientChangedEvent = TypedEvent<[
    string,
    string
], FundsRecipientChangedEventObject>;
export declare type FundsRecipientChangedEventFilter = TypedEventFilter<FundsRecipientChangedEvent>;
export interface OpenMintFinalizedEventObject {
    sender: string;
    numberOfMints: BigNumber;
}
export declare type OpenMintFinalizedEvent = TypedEvent<[
    string,
    BigNumber
], OpenMintFinalizedEventObject>;
export declare type OpenMintFinalizedEventFilter = TypedEventFilter<OpenMintFinalizedEvent>;
...
export declare type SalesConfigChangedEvent = TypedEvent<[
    string
], SalesConfigChangedEventObject>;
export declare type SalesConfigChangedEventFilter = TypedEventFilter<SalesConfigChangedEvent>;
...
export interface ERC721Drop extends BaseContract {
    ...
    functions: {
        ...
        adminMint(recipient: string, quantity: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        adminMintAirdrop(recipients: string[], overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        finalizeOpenEdition(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        initialize(_contractName: string, _contractSymbol: string, _initialOwner: string, _fundsRecipient: string, _editionSize: BigNumberish, _royaltyBPS: BigNumberish, _salesConfig: IERC721Drop.SalesConfigurationStruct, _metadataRenderer: string, _metadataRendererInit: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        isAdmin(user: string, overrides?: CallOverrides): Promise<[boolean]>;
        isApprovedForAll(nftOwner: string, operator: string, overrides?: CallOverrides): Promise<[boolean]>;
        ...
        setFundsRecipient(newRecipientAddress: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        zoraFeeForAmount(amount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        MINTER_ROLE(overrides?: CallOverrides): Promise<string>;
        SALES_MANAGER_ROLE(overrides?: CallOverrides): Promise<string>;
        adminMint(recipient: string, quantity: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        hasRole(role: BytesLike, account: string, overrides?: CallOverrides): Promise<boolean>;
        initialize(_contractName: string, _contractSymbol: string, _initialOwner: string, _fundsRecipient: string, _editionSize: BigNumberish, _royaltyBPS: BigNumberish, _salesConfig: IERC721Drop.SalesConfigurationStruct, _metadataRenderer: string, _metadataRendererInit: BytesLike, overrides?: CallOverrides): Promise<void>;
        isAdmin(user: string, overrides?: CallOverrides): Promise<boolean>;
        isApprovedForAll(nftOwner: string, operator: string, overrides?: CallOverrides): Promise<boolean>;
        metadataRenderer(overrides?: CallOverrides): Promise<string>;
        mintedPerAddress(minter: string, overrides?: CallOverrides): Promise<IERC721Drop.AddressMintDetailsStructOutput>;
        ...
        setFundsRecipient(newRecipientAddress: string, overrides?: CallOverrides): Promise<void>;
        ...
        zoraFeeForAmount(amount: BigNumberish, overrides?: CallOverrides): Promise<[string, BigNumber]>;
        zoraFeeManager(overrides?: CallOverrides): Promise<string>;
    };
    filters: {
        ...
        "FundsReceived(address,uint256)"(source?: string | null, amount?: null): FundsReceivedEventFilter;
    ...
    estimateGas: {
        ...
        isApprovedForAll(nftOwner: string, operator: string, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        royaltyInfo(arg0: BigNumberish, _salePrice: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        "safeTransferFrom(address,address,uint256)"(from: string, to: string, tokenId: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<BigNumber>;
        "safeTransferFrom(address,address,uint256,bytes)"(from: string, to: string, tokenId: BigNumberish, _data: BytesLike, overrides?: Overrides & {
    ...
    populateTransaction: {
        ...
        isApprovedForAll(nftOwner: string, operator: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        presaleMintsByAddress(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        royaltyInfo(arg0: BigNumberish, _salePrice: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "safeTransferFrom(address,address,uint256)"(from: string, to: string, tokenId: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<PopulatedTransaction>;
        "safeTransferFrom(address,address,uint256,bytes)"(from: string, to: string, tokenId: BigNumberish, _data: BytesLike, overrides?: Overrides & {
