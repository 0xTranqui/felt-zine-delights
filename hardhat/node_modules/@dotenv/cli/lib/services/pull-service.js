...
class PullService {
    constructor(environment, filename, dotenv_me) {
    ...
    _authOptions(email) {
        const url = vars_1.vars.apiUrl + '/v1/auth';
        const data = {
            email: email,
    ...
    get _pullOptions() {
        const url = vars_1.vars.apiUrl + '/v1/pull';
        const data = {
