...
export default function PostMintDialog({ colorScheme, isHolder, publicTxnLoadingStatus, publicTxnSuccessStatus, publicTxnHashLink, holderTxnLoadingStatus, holderTxnSuccessStatus, holderTxnHashLink,  }) {
